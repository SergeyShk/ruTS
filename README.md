...
Библиотека считает по леммам: для `Doc` с разметкой spaCy - по леммам и частям речи модели, для строки - по первому разбору pymorphy3, разбор зависимостей не нужен:
