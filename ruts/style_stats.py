...
class StyleStats:
    ...
    Описание:
        ...
        Доля отглагольных существительных, плотность производных предлогов, вводных
        слов и штампов считаются по спискам из constants
        ...
        Отглагольные существительные, предлоги, вводные слова и штампы считаются
        по словоформам без фильтрации (forms) независимо от переданного экстрактора
