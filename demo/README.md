...
профиль по модели `ru_core_news_sm`, связность, частотность слов по словарю Ляшевской и Шарова, SEO-метрики стиля, фоностатистики, ключевые слова и коллокации, график закона Ципфа и подсветку фрагментов,
