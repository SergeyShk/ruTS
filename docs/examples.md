...
[05_poetry.ipynb](https://github.com/SergeyShk/ruTS/blob/master/examples/05_poetry.ipynb) - стиховедческие статистики и фоностатистики на `PoetryCorpus` (16 694 стихотворения, XVIII-XX века): онегинская строфа через `VerseStats` (ударения, схемы `cC`, `ABABCCDDEFFEGG`, окончания, профиль ударности), метры по эпохам и число стоп в ямбе (александрийский стих XVIII века, пик ямба при Пушкине, трёхсложники с 1840-х, дольники и акцентный стих XX века как метр `None`), профиль ударности четырёхстопного ямба у Ломоносова, Пушкина и Блока против ручных подсчётов Тарановского, метры по авторам, схемы рифмовки четверостиший и окончания строк по эпохам, белый стих и верлибр, ударные гласные и хрестоматийная звукопись, индексы аллитерации и «жёсткость» по авторам, подсветка аллитерации, проверка ударений и рифм на наборе RIFMA.
