...
Модуль для вычисления основных метрик [удобочитаемости](https://ru.wikipedia.org/wiki/%D0%A3%D0%B4%D0%BE%D0%B1%D0%BE%D1%87%D0%B8%D1%82%D0%B0%D0%B5%D0%BC%D0%BE%D1%81%D1%82%D1%8C) текста. В качестве источника данных может использоваться как непосредственно текст, так и объект класса `Doc` библиотеки [spaCy](https://github.com/explosion/spaCy) или уже вычисленные [базовые статистики](basic_stats.md) `BasicStats` - тогда текст не разбирается повторно.
