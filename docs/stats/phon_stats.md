...
Слоги, CV-шаблоны, кластеры и зияния считаются один раз на словоформу и кэшируются, классы букв - счетчиком по всему тексту, индексы аллитерации и ассонанса - по матрице «слово × буква» через numpy, поэтому на корпусе в 340 тысяч слов статистики считаются за 0.6 с - быстрее, чем razdel режет его на слова.
