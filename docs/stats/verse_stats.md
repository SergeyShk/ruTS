...
Метр не определяется (`None`), если после подгонки больше десятой части ударений многосложных слов (`VERSE_MAX_DEVIATIONS`) остается на слабых позициях - так отсеиваются дольник, акцентный стих, верлибр и проза. Схема рифмовки записывается буквами по порядку появления, нерифмованные строки - дефисом: `ABAB`, `-A-A`. Окончания с тремя и более заударными слогами считаются гипердактилическими.
