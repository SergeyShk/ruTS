...
Лексические маркеры канцелярита: доля отглагольных существительных, плотность производных предлогов, вводных слов и штампов по спискам `COMPOUND_PREPOSITIONS`, `PARENTHETICALS` и `OFFICIALESE_CLICHES` из `ruts.constants`. Синтаксические маркеры - пассив, причастные и деепричастные обороты, цепочки родительных падежей, расщепленные сказуемые, отношение существительных к глаголам - считает [`SyntaxStats`](syntax_stats.md).
