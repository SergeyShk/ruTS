...
| :---------- | :- | :--------- |
| `NOUN` | `NOUN`, `PROPN` | имена, фамилии, отчества, топонимы и организации по пометам pymorphy3 - `PROPN` |
| `ADJF`, `ADJS`, `COMP` | `ADJ`, `DET`, `PRON` | местоименные прилагательные (этот, мой, весь) - `DET`, «который» - `PRON`; компаратив без контекста считается прилагательным |
