...
!!! example "Пример"
    ...
    punct_ellipsis                       15.691           1.998  10.798   17.247    1.888        0.733  0.867     0.0
    punct_exclamation                    14.881           3.996   9.274   12.558    1.706        0.670  0.835     0.0
    morph_verb_form_Fin                   0.761           0.695   0.056    0.077    1.161        0.594  0.797     0.0
    ...
    sents_mean                           11.122          15.136  -4.676   -3.427   -0.943       -0.531  0.235     0.0
...
У Чехова в разы больше многоточий и восклицаний на 1000 слов, короче предложения и выше доля личных форм глагола; Толстой сложнее по всем формулам удобочитаемости. Из 125 признаков у 93 поправленное p-значение ниже 0.01, но большой эффект по дельте Клиффа только у 16 - на тысячах окон значимость дешева, размер эффекта важнее.
