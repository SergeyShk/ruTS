...
| :-----: | :--------: | :--------------------------------: |
| Тест Флеша-Кинкайда | 0.79 | 4.1 |
| Индекс удобочитаемости Флеша | −0.79 | - |
| Индекс Колман-Лиау | 0.78 | 3.0 |
| Индекс SMOG | 0.81 | 4.2 |
| Автоматический индекс удобочитаемости | 0.80 | 4.0 |
| Индекс удобочитаемости LIX | 0.80 | - |
| Индекс удобочитаемости RIX | 0.78 | - |
| Формула Соловьёва, Иванова, Солнышкиной | 0.77 | 4.9 |
| Формула Мацковского | 0.75 | - |
| Индекс Дейла-Чейла | 0.82 | 3.9 |
| Индекс Ганнинга | 0.80 | 4.1 |
| Сводный класс | 0.81 | 3.7 |

Разбор по всем группам статистик - пресеты коэффициентов, лексика, синтаксис, морфология, связность и проверка на хрестоматии `SovChLit` - в ноутбуке [02_text_complexity_by_grade.ipynb](https://github.com/SergeyShk/ruTS/blob/master/examples/02_text_complexity_by_grade.ipynb).

Средний сводный класс растет с меткой: 3.2 для 1 класса, 5.8 для 3-4 классов, 6.6 для 5-9, 7.4 для 10-11 и 22.4 для документов с метками 12-17. Большая ошибка на документах ожидаема: формулы класса откалиброваны на школьных текстах, а метка 17 условна.
