import pytest
import spacy
from ruts import BasicStatsComponent, MorphStatsComponent, ReadabilityStatsComponent
from ruts.constants import BASIC_STATS_DESC, MORPHOLOGY_STATS_DESC, READABILITY_STATS_DESC
