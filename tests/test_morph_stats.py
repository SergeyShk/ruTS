...
def test_animacy(ms):
    assert ms.animacy == (None, None, None, None, None, None, None, None, None, None, None)

def test_aspect(ms):
    assert ms.aspect == ('perf', 'perf', None, None, 'impf', None, 'perf', 'perf', None, None, 'perf')

def test_case(ms):
    assert ms.case == (None, None, None, None, None, None, None, None, None, None, None)

def test_gender(ms):
    assert ms.gender == (None, None, None, None, None, None, None, None, None, None, None)

def test_involvement(ms):
    assert ms.involvement == ('excl', None, None, None, None, None, None, None, None, None, None)

def test_mood(ms):
    assert ms.mood == ('impr', None, None, None, 'indc', None, 'indc', None, None, None, 'indc')

def test_number(ms):
    assert ms.number == ('plur', None, None, None, 'plur', None, 'sing', None, None, None, 'plur')

def test_person(ms):
    assert ms.person == (None, None, None, None, '2per', None, '3per', None, None, None, None)

def test_tense(ms):
    assert ms.tense == (None, None, None, None, 'pres', None, 'futr', None, None, None, 'past')

def test_transitivity(ms):
    assert ms.transitivity == ('intr', 'tran', None, None, 'tran', None, 'intr', 'tran', None, None, 'tran')
